...
\title{A secondary screen architecture to improve recommendations in DTV environments by capturing individual user interactions}
...
\section{Conclusion}
The conclusion goes here \cite{IEEEexample:confwithvolume}.
