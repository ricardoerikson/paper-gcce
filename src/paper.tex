...
This is paper presents an architecture to accurately capture audience data in interactive TV by using secondary screen devices. The implementation of this architecture is a work in progress and its main goal is to capture viewers' interactions and contextual information to use in applications for interactive TV environments. Potential applications for this data are in the field of content personalization for TV.

Since applications in the TV domain have potential to deal with millions of users at the same time, it is interesting that this CP infrastructure has the ability to handle a growing amount of data~\cite{Lee2010,Kim2012,Shin2009}. The data from millions of viewers obtained from the implementation of this architecture can provide valuable information about viewers. To obtain this information, CPs can employ machine learning algorithms or other techniques on the raw audience data aiming to create viewer profiles for content personalization. As a result, CPs can improve their services aiming to increase the audience or enrich user experience.
